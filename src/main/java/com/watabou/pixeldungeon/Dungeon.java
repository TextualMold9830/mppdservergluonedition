...
public class Dungeon {
	...
	private static final String GAME_FILE = Main.base + "save/game.dat";
	private static final String DEPTH_FILE = Main.base + "save/depth%d.dat";
	...
	*/
	...
	public static void saveLevel() throws IOException {
		...
		System.out.println("Dungeon save: "+Path.of(Utils.format(depthFile(StartScene.curClass), depth)) );
		if (!Files.exists(Path.of(Utils.format(depthFile(StartScene.curClass), depth)))) {
			new File(Path.of(Utils.format(depthFile(StartScene.curClass), depth)).toUri()).createNewFile();
...
//		}
	...
	public static void deleteGame( boolean deleteLevels ) {
		...
		if (deleteLevels) {
			...
			while (true) {
				try {
					if(Files.exists(Paths.get(Utils.format(DEPTH_FILE, depth))) ) {
